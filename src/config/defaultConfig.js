...
export const DEFAULT_CONFIG = normalizeConfigPaths({
  logos: {
    logoOnly: {
      ...
      orange: '/assets/logo/AIVEX-orange.svg',
      black: '/assets/logo/AIVEX-black.svg',
    },
    logoHorizontal: {
      white: '/assets/logo/AIVEX-slogan-white.svg',
      orange: '/assets/logo/AIVEX-slogan-orange.svg',
      black: '/assets/logo/AIVEX-slogan-black.svg',
    },
    logoVertical: {
      white: '/assets/logo/AIVEX-slogan-white-vertical.svg',
      orange: '/assets/logo/AIVEX-slogan-orange-vertical.svg',
      black: '/assets/logo/AIVEX-slogan-black-vertical.svg',
    },
  },
  colors: {
    brand: '#FF5900',
  ...
  logoColors: [
    { id: 'white', label: '로고 흰색' },
    { id: 'orange', label: '로고 AIVEX 오렌지' },
    { id: 'black', label: '로고 검정색' },
  ],
  typography: {
    ...
    textColors: [
      ...
      { id: 'lightgray', label: '밝은 회색', value: '#FAFAFC' },
      { id: 'orange', label: '오렌지', value: '#FF5900' },
      { id: 'darkgray', label: '짙은 회색', value: '#323339' },
